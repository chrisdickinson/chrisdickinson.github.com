...
(function() {
    ...
    (function(exports){var SafeString = function(str) {
    this.str = str;
    this.isSafe = true;
};
...
NodeList.prototype.eterRender = function(context, callback) {
...
BlockNode.prototype._super = function(ready) {
    if(this.context[BLOCK_CONTEXT_KEY] && this.context[BLOCK_CONTEXT_KEY].getBlock(this.name)) {
        this.context[BLOCK_CONTEXT_KEY].getBlock(this.name).render(this.context, ready); 
    } else {
        ready(null, '');
    }
};
